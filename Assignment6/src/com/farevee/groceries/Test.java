...
public class Test
{
  ...
  public static void main(String[] args)
  {
    ...
    BulkItem organicBananas =
        new BulkItem(organicBanana, new Weight(Units.POUND, 2), 5);
    ...
    BulkContainer bag =
        new BulkContainer("bag", banana, new Weight(Units.POUND, 2), 5);
    pen.println(bag);
    ...
    BulkContainer bag2 =
        new BulkContainer("bag", banana, new Weight(Units.POUND, 3), 5);
    ...
    Package firstPackage =
        new Package("fruits", bananas, new Weight(Units.POUND, 4));
